...
1. **System Prompt** — SKILL.md 中的主持人身份、执行规则、人物库
...
从 SKILL.md 中提取"主持人与执行规则"部分作为 system message，存储在 Java 常量或配置文件。
...
public String sendMessage(String sessionId, String message) {
    ...
    trimHistory(history); // 保留 system + 最近 20 轮
    return reply;
}
```
...
6. Spring Boot 3.2.5 + JDK 17 是最稳定组合，高版本 JDK 有 Lombok 兼容问题
